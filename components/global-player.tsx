      ...
      >
        <div className="max-w-7xl mx-auto px-4 h-full flex items-center">
          <button
            ...
            className="absolute -top-6 left-1/2 transform -translate-x-1/2 bg-primary text-primary-foreground p-1.5 rounded-t-xl"
          >
        ...
        <AnimatePresence>
          {isExpanded && (
            <motion.div
              ...
              className="border-t border-glass-border px-4 flex items-center gap-4"
            >
              <span className="text-sm font-medium">{currentTrack.genre}</span>
              <span className="text-sm text-muted-foreground">•</span>
              <span className="text-sm text-muted-foreground">
                {currentTrack.plays_count} прослушиваний
              </span>
            </motion.div>
          )}
        </AnimatePresence>
